...
function Swipe(element, options) {
  ...
  this.slideChanged = this.options.slideChanged || function() {};
...
Swipe.prototype = {
  ...
  setup: function() {
    ...
    //this.width = this.container.getBoundingClientRect().width;	<- Verursacht den Fehler das bei der Random Page immer das flasche Slide angezeigvt wird uns erst nach einem Klick das richtige erscheint
	
	
	//Das hier behebt diesen Fehler
  ...
  transitionEnd: function(e) {
    ...
    this.callback(e, this.index, this.slides[this.index]);
		...
		var isValidSlide = 
          Math.abs(this.deltaX) > 80                   // and if slide amt is greater than 20px
		...
		if(isValidSlide)
		{
		//Welche Richtung: 1 = weiter; -1 = zurück;
		var direction = (this.deltaX == 0) ? 0 : (this.deltaX < 0) ? 1 : -1;
		this.slideChanged(direction);
		}
  },
